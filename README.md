...
- wastewater treatment process functions,
- reactor operational conditions,
- and modelling-relevant stoichiometric and kinetic relationships.

The framework is designed to support semantic querying, knowledge integration, ontology-driven reasoning, and future interoperability with wastewater process modelling frameworks such as PWM_SA and Gujer matrix-based systems. It also provides a foundation for future applications in digital twinning, data-driven wastewater process analysis, and ontology-assisted decision-support systems for sustainable WRRF design and optimisation.

The ontology is developed using semantic web standards including OWL, RDF, SPARQL, and SHACL, with implementation and validation performed using Protégé and Python-based semantic tools.
